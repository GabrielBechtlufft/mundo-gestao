  ...
  return (
    <div style={{ padding: "8px 56px 32px", height: "100%", display: "flex", flexDirection: "column", fontFamily: "var(--font-montserrat), sans-serif" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "32px", marginTop: "8px", flexShrink: 0 }}>
        <h1 style={{ color: "#FFFFFF", fontSize: "32px", fontWeight: 800, letterSpacing: "-0.5px", margin: 0 }}>Minhas Normas</h1>
        <button
          onClick={() => router.push("/vendedor/normas/nova")}
          style={{ background: "#00EBCB", color: "#020D1D", padding: "12px 28px", borderRadius: "12px", fontWeight: 600, fontSize: "15px", border: "none", cursor: "pointer", boxShadow: "0 4px 14px rgba(0,235,203,0.3)" }}
        >
          + Nova Norma
        </button>
      </div>
        ...
        <div style={{ flex: 1, background: "#03162D", border: "1px solid rgba(232, 237, 240, 0.15)", borderRadius: "20px", padding: "36px 48px", boxShadow: "0 8px 32px rgba(0,0,0,0.4)", height: "100%", overflowY: "auto", color: "#FFFFFF" }}>
          {loading ? (
            ...
            <div style={{ textAlign: "center", paddingTop: "60px" }}>
              <p style={{ color: "#A7B0B8", fontSize: "18px", marginBottom: "24px", fontWeight: 400 }}>Você ainda não tem normas publicadas.</p>
              <button onClick={() => router.push("/vendedor/normas/nova")} style={{ background: "#00EBCB", color: "#020D1D", padding: "14px 32px", borderRadius: "12px", fontWeight: 600, border: "none", cursor: "pointer", boxShadow: "0 4px 14px rgba(0,235,203,0.3)" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              {normasFiltradas.map((l) => (
                <div key={l.id} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "20px 24px", border: "1.5px solid rgba(232, 237, 240, 0.12)", background: "#020D1D", borderRadius: "16px" }}>
                  <div style={{ flex: 1 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "6px" }}>
                      <span style={{ background: "rgba(0, 235, 203, 0.12)", color: "#00EBCB", fontSize: "12px", fontWeight: 600, padding: "3px 10px", borderRadius: "12px" }}>{l.isoTipo}</span>
                    ...
                    {l.status === "REJEITADA" && l.motivoRejeicao && (
                      <div style={{ marginTop: "8px", background: "rgba(239, 68, 68, 0.1)", border: "1px solid rgba(239, 68, 68, 0.2)", borderRadius: "8px", padding: "8px 12px" }}>
