...
export default function VendedorChatPage() {
  ...
  return (
    <div style={{ padding: "8px 56px 32px", height: "100%", display: "flex", flexDirection: "column" }}>
      <div style={{ marginBottom: "32px", marginTop: "8px", flexShrink: 0, display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
        <div>
          ...
          <p style={{ color: "rgba(255,255,255,0.65)", fontSize: "14px", margin: 0 }}>Todas as suas conversas com compradores</p>
        </div>
          ...
          {loading ? (
            ...
            <div style={{ textAlign: "center", padding: "80px 0" }}>
              ...
              <p style={{ color: "#9CA3AF", fontSize: "13px" }}>
                {filtro === "nao_lidas" ? "Você está em dia com todas as conversas!" : "As conversas aparecerão aqui quando houver propostas."}
              </p>
            </div>
          ) : (
            <div>
              {lista.map((c, i) => {
                ...
                return (
                  <div
                    ...
                    style={{ display: "flex", alignItems: "center", gap: "14px", padding: "16px 24px", borderTop: i > 0 ? "1px solid #F3F4F6" : "none", cursor: "pointer", transition: "background 0.15s", background: c.naoLidas > 0 ? "#FAFBFF" : "transparent" }}
