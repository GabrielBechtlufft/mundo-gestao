...
export default function VendedorNavbar() {
      ...
      >
        ...
        <div style={{ borderTop: "1px solid #F3F4F6", borderBottom: "1px solid #F3F4F6", padding: "12px 0", marginBottom: "20px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0" }}>
            ...
            <span style={{ fontSize: "13px", color: "#6001D3", fontWeight: 700 }}>Certificadora</span>
          </div>
          <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0" }}>
