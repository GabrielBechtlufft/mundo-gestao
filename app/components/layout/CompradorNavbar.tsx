    ...
    >
      ...
      {profileOpen && (
        <div
          ...
          style={{ position: "fixed", inset: 0, zIndex: 40, background: "rgba(0,0,0,0.18)", backdropFilter: "blur(2px)" }}
        />
      )}
      ...
      <div style={{
        ...
        background: "#03162D", border: "1px solid rgba(232, 237, 240, 0.15)", borderRadius: "24px",
        boxShadow: "0 24px 80px rgba(0,0,0,0.5)", zIndex: 50, padding: "32px 28px 24px",
        ...
        <div style={{ borderTop: "1px solid rgba(232, 237, 240, 0.12)", borderBottom: "1px solid rgba(232, 237, 240, 0.12)", padding: "12px 0", marginBottom: "20px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0" }}>
            ...
            <span style={{ fontSize: "13px", color: "#00EBCB", fontWeight: 700 }}>Comprador</span>
          </div>
          <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0" }}>
